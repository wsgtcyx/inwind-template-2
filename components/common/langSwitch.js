	...
	return (
		<div className='dropdown dropdown-end dropdown-hover z-[100]'>
			<div
				tabIndex={0}
				role='button'
				className='bg-slate-300 flex items-center justify-center rounded-full w-15 md:w-[100px] h-8 text-base md:h-8 p-3 md:shadow-sm md:hover:shadow-md transition-all border border-gray-200 hover:border-indigo-300'
			>
